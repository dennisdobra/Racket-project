...
(define-syntax-rule (collection-car x) (stream-first x))
(define-syntax-rule (collection-cdr x) (stream-rest x))
(define-syntax-rule (collection-null? x) (stream-empty? x))
